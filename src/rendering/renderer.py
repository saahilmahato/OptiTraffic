...
class Renderer:
    ...
    def draw_vertical_roads(self):
        ...
        # Draw the roads
        pygame.draw.rect(
            self.screen, ROAD_COLOR, pygame.Rect(260, 0, road_width, window_height)
        )
        pygame.draw.rect(
            self.screen, ROAD_COLOR, pygame.Rect(560, 0, road_width, window_height)
        )
        ...
        for x in [260 + road_width // 2, 560 + road_width // 2]:
            ...
            while y < window_height:
                pygame.draw.line(
                    self.screen, LINE_COLOR, (x, y), (x, y + dash_length), line_width
                )
    ...
    def draw_horizontal_roads(self):
        ...
        # Draw the roads
        pygame.draw.rect(
            self.screen, ROAD_COLOR, pygame.Rect(0, 260, window_width, road_width)
        )
        pygame.draw.rect(
            self.screen, ROAD_COLOR, pygame.Rect(0, 560, window_width, road_width)
        )
        ...
        for y in [260 + road_width // 2, 560 + road_width // 2]:
            ...
            while x < window_width:
                pygame.draw.line(
                    self.screen, LINE_COLOR, (x, y), (x + dash_length, y), line_width
                )
